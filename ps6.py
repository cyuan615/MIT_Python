...
def is_word(word_list, word):
    ...
    '''
    word = word.lower()
    word = word.strip(" !@#$%^&*()-_+={}[]|\:;'<>?,./\"")  # remove puctuation in string
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for n in range(len(alphabetL)):
            if n < 25 - shift:
                shifdict[alphabetL[n]] = alphabetL[n + shift]
            else:
                shifdict[alphabetL[n]] = alphabetL[n + shift - 26]

        for n in range(len(alphabetU)):
            if n < 25 - shift:
                shifdict[alphabetU[n]] = alphabetU[n + shift]
            else:
